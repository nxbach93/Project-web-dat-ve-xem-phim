...
<head>
    ...
    <link rel="stylesheet" href="formDangKyNV.css">
</head>
<body>

<h2>Thêm nhân viên mới</h2>

<form method="post" action="register_process_NV.php">
    ...
    <a href="../TrangChu/formTrangChuAdmin.php" style="margin-top: 15px;">Quay lại trang quản lý</a>
</form>
